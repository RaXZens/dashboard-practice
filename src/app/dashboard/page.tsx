...
async function dashboard() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5 px-5 ">
      <div className="bg-primary-foreground p-4 rounded-lg  lg:col-span-2 xl:col-span-2 2xl:col-span-3 row-span-1">
        <AddAreaChart />
      </div>
      <div className="bg-primary-foreground p-4 rounded-lg md:col-span-1 xl:col-span-1 2xl:col-span-1 ">
        <div className="">
          <AddPieChart />
        </div>
      </div>
